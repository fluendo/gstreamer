...
#define  GST_ELEMENT_FACTORY_TYPE_FEATURE_TUNNELED (G_GUINT64_CONSTANT (1) << 20)
#define  GST_ELEMENT_FACTORY_TYPE_FEATURE_SECURE   (G_GUINT64_CONSTANT (1) << 21)
#define  GST_ELEMENT_FACTORY_TYPE_FEATURE_ADAPTIVE (G_GUINT64_CONSTANT (1) << 22)
...
#define GST_ELEMENT_FACTORY_KLASS_FEATURE_TUNNELED		"Tunneled"
#define GST_ELEMENT_FACTORY_KLASS_FEATURE_ADAPTIVE		"Adaptive"
#define GST_ELEMENT_FACTORY_KLASS_FEATURE_SECURE		"Secure"
